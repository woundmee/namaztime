...
func (s *Service) CommandHelp() string {
	...
	msg := "Ас-саляму аляйкум! Я бот для получения расписаний намазов по г. Норильск.\n\n" +
		"Расписание намазов берется с официального telegram-канала местной Норильской мечети — @nurdkamal. " +
		"Если вы нашли ошибку или у вас есть пожелания/предложения — направляйте их в сообщения группы @namaznsk\n\n" +
		"⚙ <b>Что я умею?</b>\n" +
		"/start - запуск бота\n" +
		"/help - получить справку\n" +
		"/today - расписание за сегодня\n" +
		"/unsubscribe - отписаться\n\n" +
		"ℹ️ Если вы планируете добавить бота в свою группу и получать уведомления намазов, то после добавления бота вам " +
		"необходимо в группе вызвать команду /start, а чтобы отписаться от всех уведомлений — выполните команду /unsubscribe"
